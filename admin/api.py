...
def create_movie(title: str, duration: int) -> dict:
    return _post("/movies", {"title": title, "duration": duration})


def create_cinema(name: str, location: str, capacity: int) -> dict:
    return _post("/cinemas", {"name": name, "location": location, "capacity": capacity})
